...
const grupos: Grupo[] = [
  ...
  { id: 5, nombre: "GC LA VICTORIA 01", distrito: "La Victoria", diaHora: "Jueves 8:00 PM", tipo: "Presencial", ubicacion: "Dirección referencial, La Victoria", whatsapp: "51939945787" },
  { id: 6, nombre: "GC VIRTUAL 01", distrito: "Virtual (Zoom / Meet)", diaHora: "Lunes 8:00 PM", tipo: "Virtual", ubicacion: "El link se envía por WhatsApp al inscribirte", whatsapp: "51939945787" },
  { id: 7, nombre: "GC VIRTUAL 02", distrito: "Virtual (Zoom / Meet)", diaHora: "Sábado 10:00 AM", tipo: "Virtual", ubicacion: "El link se envía por WhatsApp al inscribirte", whatsapp: "51939945787" },
]
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          {grupos.map((grupo) => (
            <div key={grupo.id} className="border border-slate-200 rounded-2xl p-5 hover:shadow-lg hover:border-emerald-200 transition-all bg-slate-50">
              <div className="flex justify-between items-start mb-3">
                ...
                <span className={`px-3 py-1 rounded-full text-xs font-bold flex items-center gap-1 ${grupo.tipo === 'Virtual' ? 'bg-blue-100 text-blue-700' : 'bg-orange-100 text-orange-700'}`}>
              ...
              <button onClick={() => handleUnirse(grupo.whatsapp, grupo.nombre)} className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 rounded-xl flex items-center justify-center gap-2 transition-all shadow-md hover:shadow-lg active:scale-95">
