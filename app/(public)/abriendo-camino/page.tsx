...
export default function AbriendoCaminoIndex() {
  ...
  const compartir = async () => {
    ...
    if (navigator.share) {
      try {
        await navigator.share({ title: 'CRECE', text: 'Un paso cada día para crecer con Dios.', url })
      } catch {}
    } else {
    ...
    <main className="min-h-screen bg-[#f4f7f6]">
      <div className="mx-auto min-h-screen w-full max-w-[520px] overflow-hidden bg-white shadow-2xl md:my-8 md:min-h-[900px] md:rounded-[32px]">
        ...
        <section className="relative h-[430px] overflow-hidden">
          <Image src="/hero-crece.jpg" alt="" fill priority className="object-cover" />
          ...
          <div className="relative z-10 flex items-center justify-between px-7 pt-6">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h1 className="text-[24px] font-black leading-none tracking-tight text-white">CRECE</h1>
                <p className="mt-1 text-[8px] font-semibold tracking-wide text-white/80">Descubre · Conecta · Crece</p>
              </div>
            </div>
            <button onClick={() => router.push('/abriendo-camino/grupos')} className="flex flex-col items-center text-white">
              ...
              <span className="mt-1 text-[9px] font-medium">Grupos</span>
            </button>
          </div>

          <div className="absolute bottom-[145px] left-0 z-10 w-full px-8">
            <p className="mb-2 text-[10px] font-bold uppercase tracking-[0.18em] text-lime-300">Tu camino de hoy</p>
            <h2 className="max-w-[340px] text-[38px] font-black leading-[0.95] tracking-tight text-white">No te quedes<br />donde estás.</h2>
            <p className="mt-3 max-w-[285px] text-[14px] leading-[1.35] text-white/90">Crece en tu relación con Dios,<br />crece en su Palabra,<br />crece para vivir tu propósito.</p>
          </div>
          ...
          <div className="absolute bottom-0 left-0 z-20 w-full px-7">
            <div className="relative overflow-hidden rounded-t-[20px] bg-[#073f3b]/95 px-5 py-4 backdrop-blur-md">
              <div className="absolute right-0 top-0 h-full w-[38%] opacity-40">
                <Image src="/hero-crece.jpg" alt="" fill className="object-cover" />
              ...
              <div className="relative z-10 flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <p className="text-[8px] font-bold uppercase tracking-[0.18em] text-white/60">Reto actual</p>
                  <h3 className="mt-0.5 text-[15px] font-black text-white">7 días — Volver a Dios</h3>
                  <p className="mt-0.5 text-[10px] text-white/70">Un encuentro que puede cambiar tu camino.</p>
                </div>
              ...
              <button onClick={handleContinuar} className="absolute right-4 top-1/2 z-20 -translate-y-1/2 text-white">
        ...
        <section className="px-7 pt-3">
          <button onClick={handleContinuar} className="flex h-[52px] w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-emerald-500 to-green-500 text-[14px] font-black text-white shadow-lg shadow-emerald-500/20 transition hover:-translate-y-0.5 hover:shadow-xl active:translate-y-0">
            {diasCompletados > 0 ? 'Continuar mi camino' : 'Comenzar mi camino'}
        ...
        <section className="px-7 pb-4 pt-5">
          <div className="mb-3">
            <p className="text-[9px] font-black uppercase tracking-[0.2em] text-emerald-700">Mi camino</p>
            <p className="mt-1 text-[11px] text-slate-400">Un paso cada día para crecer con Dios.</p>
          </div>
          ...
          <div className="grid grid-cols-4 gap-2">
            <button onClick={() => router.push('/abriendo-camino/proposito?seccion=conexion')} className="group min-h-[118px] rounded-xl bg-rose-50 p-3 text-left transition hover:-translate-y-1">
              ...
              <p className="mt-1 text-[7px] leading-[1.35] text-slate-500">Conoce a Cristo.<br />Conecta con otros.</p>
            ...
            <button onClick={() => router.push('/abriendo-camino/proposito?seccion=crecimiento')} className="group min-h-[118px] rounded-xl bg-green-50 p-3 text-left transition hover:-translate-y-1">
              ...
              <p className="mt-1 text-[7px] leading-[1.35] text-slate-500">Lee la Palabra.<br />Desarrolla tu fe.</p>
              <ArrowRight className="mt-2 h-3 w-3 text-slate-500" />
            </button>
            ...
            <button onClick={() => router.push('/abriendo-camino/proposito?seccion=servicio')} className="group min-h-[118px] rounded-xl bg-orange-50 p-3 text-left transition hover:-translate-y-1">
              ...
              <p className="mt-1 text-[7px] leading-[1.35] text-slate-500">Descubre tus dones.<br />Sirve a otros.</p>
              <ArrowRight className="mt-2 h-3 w-3 text-slate-500" />
            </button>
            ...
            <button onClick={() => router.push('/abriendo-camino/proposito?seccion=multiplicacion')} className="group min-h-[118px] rounded-xl bg-purple-50 p-3 text-left transition hover:-translate-y-1">
              ...
              <p className="mt-1 text-[7px] leading-[1.35] text-slate-500">Comparte a Jesús.<br />Haz discípulos.</p>
              <ArrowRight className="mt-2 h-3 w-3 text-slate-500" />
            </button>
          </div>
        </section>
        ...
        <section className="mx-7 mb-4 rounded-xl bg-slate-50 px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="truncate text-[9px] italic text-slate-500">"Porque yo sé los planes que tengo para ustedes..."</p>
              <p className="mt-0.5 text-[7px] font-bold uppercase tracking-wider text-slate-400">Jeremías 29:11</p>
            </div>
        ...
        <nav className="sticky bottom-0 border-t border-slate-100 bg-white/95 px-8 py-3 backdrop-blur-md">
          <div className="flex items-center justify-around">
            <button onClick={() => router.push('/abriendo-camino')} className="flex flex-col items-center gap-1 text-emerald-600">
              ...
              <span className="text-[8px] font-bold">Reto</span>
            </button>

            <button onClick={() => router.push('/abriendo-camino/oracion')} className="flex flex-col items-center gap-1 text-slate-400">
      ...
      {showLogin && <LoginModal onComplete={handleLoginComplete} onClose={() => setShowLogin(false)} />}
    </main>
  )
}
